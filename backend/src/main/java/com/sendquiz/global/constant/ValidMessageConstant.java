...
public class ValidMessageConstant {
    ...
    public static final String NICKNAME_VALID_MESSAGE = "2글자 이상 16글자 이하의 닉네임을 입력해주세요";

    public static final String PASSWORD_VALID_MESSAGE = "6글자 이상 20글자 이하의 비밀번호를 입력해주세요";
}
